...
logger.info('ref_data.var_names[:5] %s', ref_data.var_names[:5])
logger.info('ref_data.obs_names[:5] %s', ref_data.obs_names[:5])
# view of the data
logger.info('ref_data.obs.Celltype.value_counts() %s', ref_data.obs.Celltype.value_counts())

logger.info('*** show a short snippet of data')
a = ref_data[['human1_lib1.final_cell_0001', 'human1_lib1.final_cell_0003'], ['COL1A1', 'COL1A2', 'PPY', 'CTRB1']]
logger.info(a)
